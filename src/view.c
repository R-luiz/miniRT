...
/*   Updated: 2023/12/25 01:27:09 by liguyon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	camera_init(t_camera *cam, t_point3 center, double hfov)
{
	...
	vp_v = (t_vec3){0.0, -cam->vp_height, 0};
	...
	vp_upper_left =
		vec3_sub(cam->center, (t_vec3){0.0, 0.0, cam->focal_length});
	vp_upper_left = vec3_sub(vp_upper_left, vec3_div(vp_u, 2.0));
	vp_upper_left = vec3_sub(vp_upper_left, vec3_div(vp_v, 2.0));
